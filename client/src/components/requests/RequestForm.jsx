...
// // import { validateRequestForm, isValid, rules } from "@/lib/validate"
...
//                 <FormField label="Provider name" error={fieldErrors.provider_name} required>
//                   <input
//                     value={form.provider_name}
//                     onChange={e => {
//                       update("provider_name")(e)
//                       setFieldErrors(prev => ({ ...prev, provider_name: rules.provider_name(e.target.value) }))
//                     }}
//                     style={{
//                       border: fieldErrors.provider_name ? "1px solid red" : "1px solid #e5e7eb",
