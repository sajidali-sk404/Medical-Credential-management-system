      ...
      <div className="hidden md:flex relative w-1/2 flex-col"
        ...
        <div className="relative z-10 flex-1 flex flex-col items-start justify-center px-12">
          ...
          <div className="mt-12 w-full overflow-hidden">
            <div className="flex gap-8 text-white/20 font-bold text-lg tracking-widest uppercase">
              <span>CLAFE</span>
              <span>·</span>
              <span>RESEARCH</span>
              <span>·</span>
        ...
        <div className="relative z-10 p-8 flex items-center gap-3">
          <div className="flex -space-x-2">
            {["#4dd9ac", "#2196f3", "#9c27b0"].map((color, i) => (
              <div key={i}
                className="w-8 h-8 rounded-full border-2 border-teal-900 flex items-center justify-center text-white text-xs font-bold"
